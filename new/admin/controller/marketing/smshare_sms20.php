<?php
class ControllerMarketingSmshareSMS20 extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$this->response->setOutput($this->load->view('marketing/smshare_sms20.tpl', $data));
	}
			...
			if (!$json) {
				...
				switch ($this->request->post['to']) {
					case 'newsletter':
						...
						$dstCount = $this->model_sale_customer->getTotalCustomers($customer_data);
