  ...
  <div class="col-md-7">
    ...
    <table class="form pagecache">
      <tr>
        ...
        <td>
          <select name="Nitro[PageCache][Enabled]" class="form-control NitroPageCacheEnabled">
            <option value="yes" <?php echo( (!empty($data['Nitro']['PageCache']['Enabled']) && $data['Nitro']['PageCache']['Enabled'] == 'yes')) ? 'selected=selected' : ''?>>Enabled (Recommended)</option>
      ...
      <tr>
        ...
        <td>
    		<textarea class="form-control" name="Nitro[PageCache][SupportedCookies]" style="width:400px; height:180px;" placeholder="One cookie per line, e.g. header_notice*"><?php echo (!empty($data['Nitro']['PageCache']['SupportedCookies'])) ? $data['Nitro']['PageCache']['SupportedCookies'] : '' ?></textarea>
        </td>
      </tr>
      <tr>
