...
.pinchange{
	...
	background:url(image/catalog/postcode/postcode_icons.jpg);  background-repeat: no-repeat;background-position: 3px 3px;float: left;padding: 8px 0 0 22px;height: 35px;
}
@media (max-width: 767px){

.product-detail-main .product-detail .form-group label {
...
<!--             <ul>
                    ...
                    <li> <a class="addthis_button_google_plusone_shareaddthis_button_google_plusone_share at300b" href="javascript:void(0);" title="gplus"><i class="share-gplus"></i></a></li>
                </ul>-->
                ...
                <script type="text/javascript" src="//s7.addthis.com/js/250/addthis_widget.js"></script> 
                    ...
                    <div class="product-detail">
						...
						<div class="richsnippet"><div itemscope itemtype="https://schema.org/Product"><h1 itemprop="name" class="heading" title="<?php echo $heading_title; ?>"><?php echo $heading_title; ?></h1></div>
						...
						<!--<div class="price"><div itemprop="offers" itemscope itemtype="http://schema.org/Offer"><?php echo $text_price; ?><meta itemprop="priceCurrency" content="<?php echo $currencycode; ?>" />
						<link itemprop="availability" href="http://schema.org/<?php if ($stockqty>0) {echo "InStock"; } ?>-->
...
<?php //print_r($options); ?>
			...
			<!--<a class="youtube cboxElement" href="https://www.ornatejewels.com/images/ring_video.mp4"><picture>
			<source media="(max-width:767px)" srcset="images/webp/ring_size.webp"><img src="images/webp/ring_size.webp" alt="know-ring size">
			</picture></a>-->
			
			
				<a   class=" youtube cboxElement" href="images/ring_video.mp4" >
                  <img src="images/ring-size.png" alt="know-ring size" style="
...
"></span>    
			...
			<?php } ?>    
						...
						<form method = "POST"  id = "pincheck1" <?php if(isset($_SESSION['pincode'])){ echo "style='display:none;'";}?>>
							...
							<input placeholder="Enter Pincode" type="text" id="pin1" class="form-control" />
							<input type = "button"  onClick = "getdata1()" value="Check" class="pin-check " class="form-control" />
						</form>
						<div id="msg1" >
							<?php
							if(isset($_SESSION['pincode'])){
									echo "<div id='msg' class=''><label><img src='image/pincode/l.png' width='15' height='15'>Delivery option for: ".$_SESSION['pincode']."  </label><form style='display: inline;'><input type = 'button'  onclick = 'showform1()' value='Change' class='pin-check form-control' /></form><br/>";
								/*	echo "<div id="msg"><p class="pinchange"> DELIVERY OPTION FOR : <b><b>".$_SESSION['pincode']."</b></b>&nbsp;&nbsp;</p><form style="display: inline;"><input type="button" onclick="showform1()" class="form-control" value="CHANGE" style=""></form>";*/
...
<button class="wishlist" style="background-color:#fff;"  data-loading-text="<?php echo $text_loading; ?>" onclick="
			<?php if ($ga_tracking_type == 0) { echo "ga('send', 'event', '$page', 'Add to Wishlist', '".addslashes(htmlspecialchars($heading_title))."');";} else{echo "_gaq.push(['_trackEvent', '$page', 'Add to Wishlist', '".addslashes(htmlspecialchars($heading_title))."']);"; } ?> wishlist.add
			('<?php echo $product_id; ?>');"> <img src="images/add-to-wishlist.png" class="add-to-wish">Add to wishlist</button>
                        </div>
                    </div>
