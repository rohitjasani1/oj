      ...
      <table class="form minificationtoptable">
        ...
        <tr>
          ...
          <select name="Nitro[Mini][AutoExclude]" class="form-control NitroMini">
              <option value="yes" <?php echo (empty($data['Nitro']['Mini']['AutoExclude']) || $data['Nitro']['Mini']['AutoExclude'] == 'yes') ? 'selected=selected' : ''?>>Yes</option>
              <option value="no" <?php echo( (!empty($data['Nitro']['Mini']['AutoExclude']) && $data['Nitro']['Mini']['AutoExclude'] == 'no')) ? 'selected=selected' : ''?>>No</option>
          </select>
          </td>
        </tr>
      </table>  
                ...
                <table class="form minification" style="margin-top:-10px;">
                  ...
                  <tr>
                    ...
                    <select class="form-control" name="Nitro[Mini][CSSPosition]">
                        <option value="top" <?php echo (!empty($data['Nitro']['Mini']['CSSPosition']) && $data['Nitro']['Mini']['CSSPosition'] == 'top') ? 'selected=selected' : ''?>>Top of the page (Recommended)</option>
                        <option value="bottom" <?php echo (!empty($data['Nitro']['Mini']['CSSPosition']) && $data['Nitro']['Mini']['CSSPosition'] == 'bottom') ? 'selected=selected' : ''?>>Bottom of the page</option>
                    </select>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td style="vertical-align:top;">
                    <textarea class="form-control" placeholder="e.g. #cart" style="width:400px; height:180px;" name="Nitro[Mini][CSSExcludeInline]"><?php echo(!empty($data['Nitro']['Mini']['CSSExcludeInline'])) ? $data['Nitro']['Mini']['CSSExcludeInline'] : ''?></textarea>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <select class="form-control" name="Nitro[Mini][ExcludedCSSPosition]">
                        <option value="before" <?php echo (!empty($data['Nitro']['Mini']['ExcludedCSSPosition']) && $data['Nitro']['Mini']['ExcludedCSSPosition'] == 'before') ? 'selected=selected' : ''?>>Before minified</option>
                        <option value="after" <?php echo (!empty($data['Nitro']['Mini']['ExcludedCSSPosition']) && $data['Nitro']['Mini']['ExcludedCSSPosition'] == 'after') ? 'selected=selected' : ''?>>After minified</option>
                    </select>
                    </td>
                  </tr>
                  <tr>
                ...
                <table class="form minification" style="margin-top:-10px;">
                  ...
                  <tr>
                    ...
                    <select class="form-control" name="Nitro[Mini][JSPosition]">
                        ...
                        <option value="bottom" <?php echo (!empty($data['Nitro']['Mini']['JSPosition']) && $data['Nitro']['Mini']['JSPosition'] == 'bottom') ? 'selected=selected' : ''?>>Bottom of the page (Recommended)</option>
                    </select>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <select class="form-control" name="Nitro[Mini][JSDefer]">
                        <option value="no" <?php echo (empty($data['Nitro']['Mini']['JSDefer']) || $data['Nitro']['Mini']['JSDefer'] == 'no') ? 'selected=selected' : ''?>>No</option>
                        <option value="yes" <?php echo( (!empty($data['Nitro']['Mini']['JSDefer']) && $data['Nitro']['Mini']['JSDefer'] == 'yes')) ? 'selected=selected' : ''?>>Yes (Recommended)</option>
                    </select>
                    </td>
                  </tr>
                  <tr>
                ...
                <table class="form minification" style="margin-top:-10px;">
                  ...
                  <tr>
                    ...
                    <select class="form-control" name="Nitro[Mini][HTMLComments]">
                        ...
                        <option value="no" <?php echo (!empty($data['Nitro']['Mini']['HTMLComments']) && $data['Nitro']['Mini']['HTMLComments'] == 'no') ? 'selected=selected' : ''?>>No (Recommended)</option>
                    </select>
                    </td>
                  </tr>
                </table> 
