...
<div class="container">
  ...
  <div style="page-break-after: always;">
    ...
    <table class="table table-bordered">
      <thead>
        <tr>
          <td colspan="2"><?php echo $view_tracking_info; ?></td>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td style="width: 100%;">
              <?php if(!isset($error)){?>
                <b><?php echo $view_tracking_status; ?>:</b> <?php echo $status; ?><br />
                <b><?php echo $view_company; ?>:</b> <?php echo $company; ?><br />
                <b><?php echo $view_tracking_info; ?>:</b><br />
            ...
            <?php } ?>
            <a  target="_blank" href="http://global.kuaidi.com/query.html?nus=<?php echo $nu;?>"><b>get more logistics information about this order.   (kdtracker number:<?php echo $nu;?>)</b></a>
          </td>         
        </tr>
      </tbody>
    </table>
