...
<script type="text/javascript" src="view/javascript/verify.notify.min.js"></script><link href="view/stylesheet/select2.css" rel="stylesheet" />
<script type="text/javascript" src="view/javascript/select2.js"></script>
