    ...
    */
    function webDescription(){
		...
		<style type="text/css">
		    ...
		    li      { list-style-type: circle; margin-top: 10px; color: #000000; }
		    .content{margin-left: 0px; padding-bottom: 2em; }
		    .nav 	{
					padding-top: 10px; padding-bottom: 10px; padding-left: 15px; font-size: .70em;
					margin-top: 10px; margin-left: 0px; color: #000000;
					background-color:	#F8F8F8 ; width: 20%; margin-left: 20px; margin-top: 20px; 
					border : 1px solid #000000;
					}
		    .title 
					{
					font-family: arial; font-size: 26px; color: #ffffff;
					background-color: #0066aa; width: 99.8%; margin-left: 0px;
					padding-top: 10px; padding-bottom: 10px; padding-left: 15px;
					border : 1px solid #000000;
					}
		    .hidden {
					position: absolute; visibility: hidden; z-index: 200; left: 25%; top: 100px;
					font-family: arial; overflow: hidden; width: 600;
					padding: 20px; font-size: 10px; background-color:#98AFC7; layer-background-color:#FFFFFF; 
					}
		    a,a:active  { color: #cc3300; }
		...
		<div class=content>
			...
			<div class=title><i>'.$this->serviceName.' for developers</i></div>
			
			<div class=nav>
				<p>View the <a href="'.$PHP_SELF.'?wsdl">WSDL</a> for the service.
				<br>
				Click on an operation name to view details.</p>
				<ul>';
			...
			<div class=nav>
				<p>See the W3C recommendation <a href="http://www.w3.org/TR/REC-xml-names/">Namespaces in XML</a>.</p>
				<p>For more details on WSDL, see the <a href="http://www.w3.org/TR/wsdl">WSDL Specs</a>.</p>
				<p>For more details on URIs, see <a href="http://www.ietf.org/rfc/rfc2396.txt">RFC 2396</a>.</p>
			</div>
			
			<div class=nav>
				<i>&copy; <a href="utilities/admin_page.php">'.date('Y').'</a> developed by Rhea Soft Expert</i>
				<br>
				<i>for support mail us to <a href="mailto:cristian.nitu@rheasoft.ro">cristian.nitu@rheasoft.ro</a></i>
			</div>
