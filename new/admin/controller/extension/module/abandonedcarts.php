			...
			$CartProducts ='<tr>
				...
				$CartProducts .=			'<tr style="display: inline-block;float:left; margin-left: 33px; margin-top: 15px;">
						...
						$CartProducts ='<tr>
									...
									if ($product['image']) {
											$thumb = $this->model_tool_image->resize($product['image'], '195', '195');
										} else {
											$image = false;
										}
						
									$CartProducts .='	<tr style="display: inline-block;float:left;">
									<td height="205px" align="left" style="display:inline-block;float:left; padding-left:10px">
									<a href='.$product["href"].'><img src='.$thumb .' title='.$product["name"]. 'style="width:200px;margin:5px auto;MARGIN-LEFT:0px"></a>
									...
									<td width="200px">
									<p style="margin-left:0px; display: inline-block; margin-top: 50px;font-family: Ubuntu;font-size: 18px;padding:5px;">'.$product["name"].'</p>';
						...
						$CartProducts .='	</td>
						<td width="75px">
						<p style="margin-left:0px;display:inline-block;margin-top:50px;font-family:Ubuntu;font-size:18px;margin-left:20px;">'.$product["quantity"].' Qty</p>
						</td>
						<td width="110px">
						<p style="margin-left:0px;display:inline-block;margin-top:50px;font-family:Ubuntu;font-size:18px;margin-left:20px;">'.$product["price"].'</p>
						</td>
				...
				foreach ($product_query as $product) {
					...
					//	'href'    	 => $this->url->link('product/product', 'product_id=' . $product['product_id']),
						'href'    	 => 'www.ornatejewels.com/index.php?route=product/product&product_id=' . $product['product_id'],
//
					...
					//	'price'    => $this->currency->format($product['price'] + ($this->config->get('config_tax') ? $product['tax'] : 0), $order_info['currency_code'], $order_info['currency_value']),
							...
							<tr>
                                <td height="250" align="left" style="display:inline-block;float:left;margin-top:22px;">';
									foreach ($data['req_products']  as $prod){ 
										$recomandateProducts .= '<a href='.$prod["href"].'><img src='.$prod["thumb"].'  style="width:200px;padding-left:10px;"></a>';
											} 
							
                                                      
                                      $recomandateProducts .= '                   </td>
								</tr>
								<tr style="display: inline-block;float:left;margin-top: -27px; ">';
						       foreach ($data['req_products']  as $prod){
									$recomandateProducts .= '   <td style="display:inline-block;float:left;width:210px;    text-align: center;font-family:Ubuntu;font-size: 17px; "><a href='.$prod["href"].'>'.$prod['name'].'<br>'.$prod['price'].'</a></td>';
									} 
						      
									$recomandateProducts .=          '</tr>';		
