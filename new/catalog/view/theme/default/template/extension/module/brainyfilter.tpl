...
<div class="bf-panel-wrapper<?php if($isResponsive) : ?> bf-responsive<?php endif; ?> <?php echo $responsivePos; ?> bf-layout-id-<?php echo $layout_id;?>">
    ...
    <div class="boxfilter bf-check-position <?php if ($isHorizontal) : ?>bf-horizontal<?php endif; ?>">
         <div class="box-heading"><?php echo 'Filter'; ?><?php if ($isHorizontal) : ?><a class="bf-toggle-filter-arrow"></a><input type="reset" class="bf-buttonclear" onclick="BrainyFilter.reset();" value="<?php echo $reset; ?>" /><?php endif; ?></div> 
                        ...
                        <div class="bf-attr-block-cont">
                            <div class="bf-price-container box-content bf-attr-filter">
                                ...
                                <!--<div class="bf-cur-symb">
                                    ...
                                    <input type="text" class="bf-range-min" name="bfp_price_min" value="<?php echo '0'; ?>" size="4" />
                                ...
                                <div class="bf-price-slider-container <?php if($sliderType === 2 || $sliderType === 3): ?>bf-slider-with-labels<?php endif; ?>">
                                    <div style="color:green;" class="bf-slider-range" data-slider-type="<?php echo $sliderType; ?>"></div>
									<div class="bf-cur-symb">
                                    <span class="bf-cur-symb-left"><?php echo $currency_symbol; ?></span>
                                    <input type="text" class="bf-range-min" name="bfp_price_min" value="<?php echo '0'; ?>" size="4" />
                                <!--<select class="min" name="min-price"><option value="0" class="">0</option><option value="500" class="">₹500</option><option value="1000" class="">₹1000</option><option value="1500" class="">₹1500</option><option value="2000" class="">₹2000</option></select>-->
                                    ...
                                    <span class="bf-cur-symb-left"><?php echo $currency_symbol; ?></span>
                                    <input type="text" class="bf-range-max" name="bfp_price_max" value="<?php echo $upperlimit; ?>" size="4" /> 
									<!--<select class="max"><option value="500" class="">₹500</option><option value="1000" class="">₹1000</option><option value="1500" class="">₹1500</option><option value="2000" select="selected">₹2000</option><option value="2000" class="">₹2000+</option></select>-->
