...
function extractHardcodedResources($content) {
    ...
    foreach ($elements as $el) {
        switch ($el->tagName) {
            ...
            case 'link':
                ...
                if ($attr && !empty($attr->value) && (!nitroIsIgnoredUrl($attr->value, $cssExclude, $cssExcludeMeta) || nitroIsUrlToBeExtracted($attr->value, $cssExcludeMeta))) {
    ...
    return $dom->getHtml($include_comments);
}
