...
<td class="text-right"><?php echo 'Action'; ?></td>
          ...
          <tbody>
			...
			<td class="" style="width:100px"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-thumbnail" /></td>
			  ...
			  <!--
<td class="text-right"><a href="<?php echo $product['reorder']; ?>" title="<?php echo 'Reorder'; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart"></i></a>
			<a href="<?php echo  $product['return']; ?>" title="<?php echo 'Return'; ?>" class="btn btn-danger"><i class="fa fa-reply"></i></a>
