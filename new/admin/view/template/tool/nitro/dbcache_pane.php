      ...
      <table class="form cdnpanetable">
        <tr>
          ...
          <select name="Nitro[DBCache][Enabled]" class="form-control DBCache">
              <option value="no" <?php echo (empty($data['Nitro']['DBCache']['Enabled']) || $data['Nitro']['DBCache']['Enabled'] == 'no') ? 'selected=selected' : ''?>>Disabled (Recommended)</option>
                ...
                <table class="form" style="margin-top:-10px;">
                  <tr>
                    ...
                    <select class="form-control" name="Nitro[DBCache][CacheDepo]">
                        ...
                        <option value="ram_memcache" <?php echo( (!empty($data['Nitro']['DBCache']['CacheDepo']) && $data['Nitro']['DBCache']['CacheDepo'] == 'ram_memcache')) ? 'selected=selected' : ''?> <?php if (!class_exists('Memcache')) { echo 'disabled=disabled style="color:#aaa;"'; } ?>>Memory (RAM) - Memcache</option>
                    </select><br />
                ...
                <table class="form" style="margin-top:-10px;">
                  <tr>
                    ...
                    <select class="form-control" name="Nitro[DBCache][ProductCountQueries]">
                        ...
                        <option value="yes" <?php echo( (!empty($data['Nitro']['DBCache']['ProductCountQueries']) && $data['Nitro']['DBCache']['ProductCountQueries'] == 'yes')) ? 'selected=selected' : ''?>>Yes (Recommended)</option>
                    </select>
                    </td>
                  </tr>
                </table> 
                ...
                <table class="form" style="margin-top:-10px;">
                  <tr>
                    ...
                    <select class="form-control" name="Nitro[DBCache][CategoryQueries]">
                        <option value="no" <?php echo (empty($data['Nitro']['DBCache']['CategoryQueries']) || $data['Nitro']['DBCache']['CategoryQueries'] == 'no') ? 'selected=selected' : ''?>>No (Recommended)</option>
                  ...
                  <tr>
                    ...
                    <select class="form-control" name="Nitro[DBCache][CategoryCountQueries]">
                        ...
                        <option value="yes" <?php echo( (!empty($data['Nitro']['DBCache']['CategoryCountQueries']) && $data['Nitro']['DBCache']['CategoryCountQueries'] == 'yes')) ? 'selected=selected' : ''?>>Yes (Recommended)</option>
                    </select>
                    </td>
                  </tr>
                </table> 
                ...
                <table class="form" style="margin-top:-10px;">
                  <tr>
                    ...
                    <select class="form-control" name="Nitro[DBCache][SeoUrls]">
                        ...
                        <option value="yes" <?php echo( (!empty($data['Nitro']['DBCache']['SeoUrls']) && $data['Nitro']['DBCache']['SeoUrls'] == 'yes')) ? 'selected=selected' : ''?>>Yes (Recommended)</option>
                    </select>
                    </td>
                  </tr>
                </table> 
