        ...
        <tr>
		 <td><b><?php echo 'Image'; ?></b></td>
          ...
          <td class="text-right"><b><?php echo $column_total; ?></b></td>
		   <td class="text-right"><b><?php echo 'GST'; ?></b></td>
		   <?php if(($order['coupon'] !=  'Rs 0')){ ?>
		  <td class="text-right"><b><?php echo 'Coupon'; ?></b></td>
      ...
      <tbody>
		...
		<td class="" style="width:100px"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-thumbnail" /></td>
          ...
          <td class="text-right"><?php echo $product['total']; ?></td>
		   ...
		   <?php if(($order['coupon'] !=  'Rs 0')){ ?><td class="text-right"><?php echo $order['coupon']; ?></td><?php } ?>
