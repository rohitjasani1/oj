  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button id="button-send" data-loading-text="<?php echo $text_loading; ?>" data-toggle="tooltip" title="<?php echo $button_send; ?>" class="btn btn-primary" onclick="send('index.php?route=marketing/smshare_sms21/send&token=<?php echo $token; ?>');"><i class="fa fa-envelope"></i></button>
      ...
      <div class="panel-body">
        <form class="form-horizontal">
          ...
          <div class="form-group comment">
            <label class="col-sm-2 control-label" for="input-comment"><span data-toggle="tooltip" title="For you only as reference, not seen by customers"><?php echo "Comment"; ?></span></label>
            <div class="col-sm-10">
              <input type="text" name="comment" value="" id="input-comment" class="form-control" />
            </div>
          </div>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <textarea name="message" placeholder="<?php echo $entry_message; ?>" id="input-message" class="form-control" style="height: 200px;"></textarea>
            </div>
          </div>
        </form>
      </div>
